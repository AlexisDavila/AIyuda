      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-slate-500">
            Cargue imágenes médicas para ejecutar un análisis de diagnóstico basado en IA.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-6 rounded-xl border border-[#E1E5EA] bg-white p-6 shadow-sm">
            ...
            {result && (
              <div className="rounded-lg border border-[#E1E5EA] bg-gradient-to-br from-[#18D2D5]/10 to-[#18D2D5]/5 p-6">
                ...
                <div className={`rounded-md ${result.prediction === 1 ? "bg-red-500" : "bg-[#18D2D5]"} p-4 text-white`}>
                  <p className="text-xs opacity-90">Predicción por Imagen</p>
